...
if __name__ == '__main__':
    ...
    # if cuda:
    #     model.cuda()
    # train_embeddings_baseline, train_labels_baseline, images_list = utils.extract_embeddings(train_loader, model)
    ...
    imgfilepath1=os.path.join(current_dir, r'..\test_img\563766000.png')
    imgfilepath2=os.path.join(current_dir, r'..\test_img\255806425.png')
    cuda = torch.cuda.is_available()
    print(cuda)
